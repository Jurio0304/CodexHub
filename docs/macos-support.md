...
Status: macOS release-build support is merged into `master`. The v0.2.3 macOS public artifact is unsigned/ad-hoc and still requires real Mac validation before treating behavior as fully verified.

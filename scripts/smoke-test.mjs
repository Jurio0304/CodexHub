...
if (packageJson.version !== "0.4.1") fail("package version should be 0.4.1");
...
if (tauriConfig.version !== "0.4.1") fail("stable Tauri version should be 0.4.1");
...
if (devTauriConfig.version !== "0.4.1") fail("dev Tauri version should be 0.4.1");
...
const requiredText = [
  ...
  [readme, "CodexHub_0.4.1_aarch64.dmg"],

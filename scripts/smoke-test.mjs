...
if (packageJson.version !== "0.4.5") fail("package version should be 0.4.5");
...
if (tauriConfig.version !== "0.4.5") fail("stable Tauri version should be 0.4.5");
...
if (devTauriConfig.version !== "0.4.5") fail("dev Tauri version should be 0.4.5");
...
const requiredText = [
  ...
  [readme, "CodexHub_0.4.5_aarch64.dmg"],
  [readme, "CodexHub_0.4.5_amd64.deb"],
  [readme, "CodexHub_0.4.5_arm64.deb"],

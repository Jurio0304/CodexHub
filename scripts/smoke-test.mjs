...
if (packageJson.version !== "0.4.6") fail("package version should be 0.4.6");
...
if (tauriConfig.version !== "0.4.6") fail("stable Tauri version should be 0.4.6");
...
if (devTauriConfig.version !== "0.4.6") fail("dev Tauri version should be 0.4.6");
...
const requiredText = [
  ...
  [readme, "CodexHub_0.4.6_aarch64.dmg"],
  [readme, "CodexHub_0.4.6_amd64.deb"],
  [readme, "CodexHub_0.4.6_arm64.deb"],

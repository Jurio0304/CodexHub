...
if (packageJson.version !== "0.2.7") fail("package version should be 0.2.7");
...
if (tauriConfig.version !== "0.2.7") fail("stable Tauri version should be 0.2.7");
...
if (devTauriConfig.version !== "0.2.7") fail("dev Tauri version should be 0.2.7");
...
const requiredText = [
  ...
  [readme, "CodexHub_0.2.7_aarch64.dmg"],

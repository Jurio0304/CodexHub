...
mod tests {
    ...
    fn macos_paths_follow_codexhub_contract() {
        let home = Path::new("/Users/jurio");

        assert_eq!(get_ssh_dir_for_home(home), PathBuf::from("/Users/jurio/.ssh"));
        assert_eq!(
            get_default_ssh_key_path_for_home(home),
            PathBuf::from("/Users/jurio/.ssh/id_ed25519")
        );
        assert_eq!(
            get_codex_config_path_for_home(home),
            PathBuf::from("/Users/jurio/.codex/config.toml")
        );
        assert_eq!(
            get_codex_skills_path_for_home(home),
            PathBuf::from("/Users/jurio/.codex/skills")
        );
    }
    ...
    fn macos_codex_binary_candidates_keep_required_order() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                PathBuf::from("/Users/jurio/.local/bin/codex")
            ]
        );
    }

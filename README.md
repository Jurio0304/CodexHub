<div align="center">
  ...
  <p>
    <img alt="Release" src="https://img.shields.io/badge/release-v0.3.0-2563eb" />
...
* Windows: download and run `CodexHub_0.3.0_x64-setup.exe`; signed stable installers can check and install future Windows updates from Settings.
* macOS Apple Silicon: download `CodexHub_0.3.0_aarch64.dmg`, open it, and move `CodexHub.app` to Applications. The macOS build is unsigned/ad-hoc, so macOS may require Control-click > Open or Privacy & Security approval the first time. Only trust files downloaded from this repository's Release page.

<div align="center">
  ...
  <p>
    <img alt="Release" src="https://img.shields.io/badge/release-v0.4.1-2563eb" />
...
* Windows: download and run `CodexHub_0.4.1_x64-setup.exe`; signed stable installers can check and install future Windows updates from Settings.
* macOS Apple Silicon: download `CodexHub_0.4.1_aarch64.dmg`, open it, and move `CodexHub.app` to Applications. The v0.4.1 macOS artifact is unsigned/ad-hoc and should be real-Mac validated before broad rollout, so macOS may require Control-click > Open or Privacy & Security approval the first time. Only trust files downloaded from this repository's Release page.
...
* The v0.4.1 macOS artifact still requires real-device validation for this release, and Developer ID signing and notarization are not configured yet.
